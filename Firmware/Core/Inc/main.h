...
/* Private defines -----------------------------------------------------------*/
#define SS4_A_CTRL2_Pin GPIO_PIN_5
#define SS4_A_CTRL2_GPIO_Port GPIOE
#define SS4_A_CTRL3_Pin GPIO_PIN_6
...
#define CTRL4_GPIO_Port GPIOE
#define SS4_B_CTRL3_Pin GPIO_PIN_11
#define SS4_B_CTRL3_GPIO_Port GPIOE
#define SS4_B_CTRL2_Pin GPIO_PIN_13
#define SS4_B_CTRL2_GPIO_Port GPIOE
#define SS4_B_CTRL1_Pin GPIO_PIN_14
#define SS4_B_CTRL1_GPIO_Port GPIOE
#define SS4_B_CTRL0_Pin GPIO_PIN_10
#define SS4_B_CTRL0_GPIO_Port GPIOB
...
#define SS4_A_SEL2_Pin GPIO_PIN_15
#define SS4_A_SEL2_GPIO_Port GPIOB
#define SS4_A_SEL1_Pin GPIO_PIN_8
#define SS4_A_SEL1_GPIO_Port GPIOD
#define SS4_A_SEL0_Pin GPIO_PIN_9
#define SS4_A_SEL0_GPIO_Port GPIOD
#define SS2_B_CTRL1_Pin GPIO_PIN_12
#define SS2_B_CTRL1_GPIO_Port GPIOD
#define SS2_B_CTRL0_Pin GPIO_PIN_13
#define SS2_B_CTRL0_GPIO_Port GPIOD
#define SS2_B_SEL0_Pin GPIO_PIN_14
#define SS2_B_SEL0_GPIO_Port GPIOD
#define SS2_B_SEL1_Pin GPIO_PIN_15
#define SS2_B_SEL1_GPIO_Port GPIOD
#define SS2_A_SEL0_Pin GPIO_PIN_6
#define SS2_A_SEL0_GPIO_Port GPIOC
#define SS2_A_SEL1_Pin GPIO_PIN_7
#define SS2_A_SEL1_GPIO_Port GPIOC
#define SS2_A_CTRL1_Pin GPIO_PIN_8
#define SS2_A_CTRL1_GPIO_Port GPIOC
#define SS2_A_CTRL0_Pin GPIO_PIN_9
#define SS2_A_CTRL0_GPIO_Port GPIOC
#define SP1_nCS_Pin GPIO_PIN_5
#define SP1_nCS_GPIO_Port GPIOD
